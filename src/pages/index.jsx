import "@/index.css";
import "@/landing.css";
import { landing } from '@/store/general/thunk'
import { useSelector, useDispatch } from 'react-redux'
import { useEffect } from 'react'

function Index() {
    const dispatch = useDispatch()
    const landingState = useSelector((state) => state.general.landing)
...
<div className="h-screen pb-14 bg-right bg-cover" style={{backgroundImage: `url('https://www.tailwindtoolbox.com/templates/bg.svg')`}}>
    ...
    <div className="container pt-24 md:pt-48 px-6 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div className="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden">
            ...
            <div className="flex w-full justify-center md:justify-start pb-24 lg:pb-0 fade-in">
                <img src="https://www.tailwindtoolbox.com/templates/App%20Store.svg" className="h-12 pr-4 bounce-top-icons" />
                <img src="https://www.tailwindtoolbox.com/templates/Play%20Store.svg" className="h-12 bounce-top-icons" />
            </div>

        </div>

        <div className="w-full xl:w-3/5 py-6 overflow-y-hidden">
            <img className="w-5/6 mx-auto lg:mr-0 slide-in-bottom" src="https://www.tailwindtoolbox.com/templates/devices.svg" />
        </div>
